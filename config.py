...
class Config(object):
    ...
    # database url
    DATABASE_URL = int(os.environ.get("DATABASE_URL", "mongodb+srv://Tamilbots:tamilbots@cluster0.aa2e1nd.mongodb.net/?retryWrites=true&w=majority"))
    SESSION_NAME = int(os.envirin.get("SESSION_NAME", "Tamilbots")) 
